...
export class UsersController {
  ...
  @Patch(':id') @Roles('Super User', 'COO', 'Manager', 'Analyst') update(@Param('id') id: string, @Body() dto: UpdateUserDto) { return ok('User updated.', this.usersService.update(id, dto)); }
  @Put(':id') @Roles('Super User', 'COO', 'Manager', 'Analyst') replace(@Param('id') id: string, @Body() dto: UpdateUserDto) { return ok('User updated.', this.usersService.update(id, dto)); }
